...
router.get("/productDashboard", isAuthenticated, isAdmin, (req, res) => {
    productsModel.find()
        .then((products) => {
            const filteredProducts = products.map(product => {
                return {
...
router.get("/product/addCategory", isAuthenticated, isAdmin, (req, res) => {
    res.render("products/categoryAddForm", {
        title: `Add Category`
    });
});

router.post("/product/addCategory", isAuthenticated, isAdmin, (req, res) => {
...
router.post("/product/add", isAuthenticated, isAdmin, (req, res) => {
...
router.get("/product/edit/:id", isAuthenticated, isAdmin, (req, res) => {
...
router.put("/product/update/:id", isAuthenticated, isAdmin, (req, res) => {
...
router.delete("/product/delete/:id", isAuthenticated, isAdmin, (req, res) => {
...
router.post("/products/search", isAuthenticated, isAdmin, (req, res) => {
    const search = req.body["products-search"];
    if (search == "all") {
        res.redirect("/productDashboard");
    } else {
    ...
    productsModel.find()
        .then((products) => {
            ...
            filteredProducts.forEach((product) => {
                if (product.title.toLowerCase().includes(searchValue.toLowerCase()) || product.category.toLowerCase().includes(searchValue.toLowerCase())) {
