const products = {
    ...
    init() {
        ...
        productsModel.find((err, products)=>{
            ...
            if(product.category == "Valentine's Gift") {
                product.href="/valentine";
            }
            if(product.category == "Electronics & Accessories") {
                product.href="/electronic";
            }
            if(product.category == "Home") {
                product.href="/revhome";
            }
            if(product.category == "Fitness") {
                product.href="/fitness";
            }
            that.fakeDB.push(product);
            });    
        }); */
    },
